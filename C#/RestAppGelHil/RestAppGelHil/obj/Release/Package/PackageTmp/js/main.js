...
<td class="tg-0pky">
            ...
            $('.dashboard').append('<div>In this month, i.e.' + currentMonth + '/' + currentYear + ', there are ' + fullDays.length + ' fully staffed days and ' + emptyDays.length + ' understaffed days.</div>');
        });
    } 
